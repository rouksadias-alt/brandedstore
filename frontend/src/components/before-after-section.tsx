...
// fotos de producto limpias, P0.2 — ver LEGER_FOTOS_CHECKLIST.md, sección 5).
// En cuanto existan, pásalas como `beforeSrc`/`afterSrc` y esta sección
// renderiza automáticamente el slider arrastrable en vez de la comparación
// en texto/íconos (mismo patrón centralizado que ProductVisual).
const beforePoints = [
