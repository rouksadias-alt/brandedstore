        ...
        {tiers.map((tier) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex flex-col items-center gap-1 rounded-2xl border-2 px-4 py-6 text-center transition-all",
                isSelected
            ...
            >
              {tier.badge && (
                <span
                  className={cn(
                    "absolute -top-3 rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-white",
